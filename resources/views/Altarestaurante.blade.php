<title>Alta de Restaurantes</title>
@extends('index2')
@section('contenido')
...
<div class="container">
	<div class="card">
		<h5 class="card-header">Alta de Restaurantes</h5>
		<div class="card-body">
        <div class="form-group">
		{{Form::label('Clave_restaurante', 'Clave de Restaurante')}}
		@if ($errors ->first('Clave_restaurante'))
			<p><i>{{$errors->first('Clave_restaurante')}}</i></p>
		@endif
		{{Form::text('Clave_restaurante',$idsigue,['readonly','class' => 'form-control'])}}
	</div>
    <div>
	<div class="form-group">
