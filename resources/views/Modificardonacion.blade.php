<title>Modificacion de donaciones</title>
@extends('index2')
@section('contenido')
{{Form::open (['route' => 'Guardadonacion'])}}
{{Form::token()}}
<div class="container">
	<div class="card">
		<h5 class="card-header">Modificacion de donaciones</h5>
		<div class="card-body">
			<div class="form-group">
				...
				@endif
				{{Form::text('Clave_donacion',$consulta->Clave_donacion,['readonly','class' => 'form-control'])}}
			</div>
			<div class="form-group">
