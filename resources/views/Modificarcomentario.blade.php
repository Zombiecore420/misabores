...
@extends('index2')
@section('contenido')
{{Form::open (['route' => 'Guardaedicioncomentario','files' => 'true'])}}
{{Form::token()}}
<div class="container">
	<div class="card">
		<h5 class="card-header">Modificacion de Comentarios</h5>
		<div class="card-body">
			<div class="form-group">
				...
				@endif
				{{Form::text('Clave_comentario',$consulta->Clave_comentario,['readonly','class' => 'form-control'])}}
			</div>
			
			</div>
			<div class="form-group">
				{{Form::label('tamaño', 'Estrellas')}}
				@if ($errors ->first('tamaño'))
					<p><i>{{$errors->first('tamaño')}}</i></p>
				@endif
